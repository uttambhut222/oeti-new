$('.menu_btn').click(function () {
	$('.pp-scrollable.section').addClass("active_menu_right_block");
	$('.footer_fixed').addClass("active_menu_right_block");
	$('.click-capture').css("visibility","hidden");
});
$('.close-menu').click(function () {
	$('.pp-scrollable.section').removeClass("active_menu_right_block");
	$('.footer_fixed').removeClass("active_menu_right_block");
});
