...
<div class="inner_banner work_banner">
    <img src="images/inner_banner.jpg" alt="" class="img-responsive" />
  	<div class="innerbanner_text">ATD<br><!--<a href="#" class="read_more"><i class="flaticon-worldwide"></i>Visit Website</a>--></div>
</div>
...
<div class="inner_block about_project">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <a href="work" class="read_more pull-left"><i class="flaticon-left-arrow"></i> Back to Portfolio</a><a href="learnfeedback_detail" class="read_more pull-right">Next Project <i class="flaticon-right-arrow"></i></a>
	  </div>
      <div class="col-md-10 col-md-offset-1 col-sm-12">
        <div class="text-center">
			<div class="img_computer"><img src="images/app-03.png" class="img-responsive" alt="app" /></div>
          	<h2>About Project</h2>
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6">
            <div class="feature_block"><img src="images/ipad03.jpg" alt="" class="img-responsive" /></div>
          </div>
          <div class="col-md-6 col-sm-6">
            <div class="feature_block"><img src="images/mobile03.jpg" alt="" class="img-responsive" /></div>
          </div>
        </div>
        <div class="clearfix"></div>
        <!--
