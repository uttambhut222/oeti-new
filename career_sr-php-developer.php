...
<div class="inner_banner">
    <img src="images/inner_banner.jpg" alt="" class="img-responsive" />
  	<div class="innerbanner_text">Why to Choose us<span><a href="index">Home</a> / <a href="career">Career</a> / <i>Sr. PHP Developer</i></span></div>
</div>
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1 col-sm-12">
				<div class="text-center">
				  <h2>Sr. PHP Developer</h2>
					<div class="separator text-center"><span class="dott"></span><span class="dott"></span><span class="dott"></span></div>
				  <p class="padding_30">OpenEyes is hiring Team Lead / Sr. PHP Developer for product and project development in Web, Mobile & Cloud App Development.</p>
				</div>
