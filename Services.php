...
<div class="pagepiling">
	<div class="pp-scrollable section our_services">
			...
			<div class="scrollable-content">
				<div class="vertical-centred">
					<div class="boxed boxed-inner">
						<div class="vertical-title text-dark hidden-xs hidden-sm"><span>what we do</span>
						</div>
						<div class="boxed">
							<div class="container">
								<div class="intro">
													...
													<div class="resume-content">
														<div class="resume-inner">
															<div class="resume-row">
																...
																<ul class="resume-type">
																	<li title="Power PI" data-toggle="tooltip" data-placement="bottom"><img alt="" class="img-responsive" src="assets/images/services/pi.png">
																	</li>
																	<li title="Tableau" data-toggle="tooltip" data-placement="bottom"><img alt="" class="img-responsive" src="assets/images/services/tableau.png">
																	</li>
																</ul>
															</div>
														</div>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 col-md-offset-2 col-lg-offset-2 service_grid">
												<div class="col-resume">
													...
													<div class="resume-content">
														<div class="resume-inner">
															<div class="resume-row">
																<p class="resume-study">We strongly believe that for any business to succeed, it must be able to listen to its customers and identify areas for continuous improvement - and this can only be achieved if you have a World class customer service team that are passionate about what we do.</p>
																<ul class="resume-type">
																	<li title="Slack" data-toggle="tooltip" data-placement="bottom"><img alt="" class="img-responsive" src="assets/images/services/slack.png">
																	</li>
																</ul>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 service_grid">
												<div class="col-resume">
													...
													<div class="resume-content">
														<div class="resume-inner">
															<div class="resume-row">
																<p class="resume-study">Life and business are about moving forward. We will keep looking for new ways to make things better with new ideas, new solutions and new approaches to make things easier for our customers. That way, we can all stay a step ahead.</p>
																<ul class="resume-type">
																	<li title="Angular" data-toggle="tooltip" data-placement="bottom"><img alt="" class="img-responsive" src="assets/images/services/angular.png">
																	</li>
																	<li title="Codeigniter" data-toggle="tooltip" data-placement="bottom"><img alt="" class="img-responsive" src="assets/images/services/codeigniter.png">
