	...
	if ($uploadOk == 1)
	{
		...
		if ($conn->query($sql) === TRUE) {
			...
			require_once('email/class.phpmailer.php');
				...
				$mail->Subject = "Career Application - OpenEyes Technologies";
				$mail->Body = '
				<table border="1" cellpadding="0" cellspacing="0" style="border:1px solid rgb(120, 120, 120); color:#000000; font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:22px; margin:0 auto; width:600px">
					<tbody>
						...
						<tr>
							...
							<p><span style="font-size:13pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">The following Candidate has sent their details:</span></span></span></p>

							<p style="margin:0in 0in 8pt"><span style="font-size:11pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">Position Applied For:&nbsp;'.$Position.'</span></span></span></p>
							...
							<p style="margin:0in 0in 8pt"><span style="font-size:11pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">Present Salary(per Year):&nbsp;'.$Salary.'</span></span></span></p>

							<p style="margin:0in 0in 8pt"><span style="font-size:11pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">Type of Employment:&nbsp;'.$EmploymentType.'</span></span></span></p>
							
							<p style="margin:0in 0in 8pt"><span style="font-size:11pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">Please find the attached resume.</span></span></span></p>
							</td>
						</tr>
						<tr>
				...
				';
				$mail->addAttachment($target_dir.$newfilename);
				...
				$mail->Subject = "Thank you for your Application - OpenEyes Technologies Inc.";
				$mail->Body = '
				<table border="1" cellpadding="0" cellspacing="0" style="border:1px solid rgb(120, 120, 120); color:#000000; font-family:Arial,Helvetica,sans-serif; font-size:15px; line-height:22px; margin:0 auto; width:600px">
					<tbody>
						<tr>
						...
						<tr>
							<td style="padding:10px">
								<h1 style="font-family:Calibri,sans-serif;">Thank you for your Application</h1>
								<h3 style="font-family:Calibri,sans-serif;">Your Application has been sent successfully.</h3>
								<p></p>
								<p style="font-family:Calibri,sans-serif">It has been forwarded to the relevant department and will be dealt with as soon as possible.</p>
								<p></p>
							...
							<div class="row">
							  <div class="col-md-4 col-sm-4">
								<div class="form-group file_upload">
								  <input type="text" placeholder="*No File Selected" disabled /><input type="file" name="fileToUpload" id="fileToUpload" required accept="application/pdf,application/msword,
