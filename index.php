	...
	<div data-anchor="ourwork" class="pp-scrollable text-white section section-3 ourwork_section">
		<div class="scroll-wrap">
			<div class="bg-changer">
				<div class="section-bg active" style="background-size: cover!important;background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%),url(assets/images/bg/afpbg.jpg) no-repeat;"></div>
