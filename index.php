...
<div class="pagepiling">
			...
			<div class="scrollable-content">
				<div class="vertical-centred">
					<div class="boxed boxed-inner">
						<div class="vertical-title text-dark hidden-xs hidden-sm"><span>who we are</span>
						</div>
						<div class="boxed">
							<div class="container">
								<div class="intro">
	...
	<div data-anchor="ourwork" class="pp-scrollable text-white section section-3 ourwork_section">
		<div class="scroll-wrap">
			<div class="bg-changer">
				<div class="section-bg" style="background-size: cover!important;background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%),url(assets/images/bg/afpbg.jpg) no-repeat;"></div>
				<div class="section-bg" style="background-size: cover!important;background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%),url(assets/images/bg/atdbg.jpg) no-repeat;"></div>
	...
	<div data-anchor="ourservices" class="pp-scrollable text-white section section-6">
		<div class="scroll-wrap">
			<div class="section-bg" style="background:url(assets/images/bg/bg3.jpg);"></div>
			<div class="scrollable-content">
				<div class="vertical-centred">
					<div class="boxed boxed-inner">
													...
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="Angular" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/angular.png">
																</li>
																<li title="Node JS" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/node.png">
																</li>
																<li title="Codeigniter" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/codeigniter.png">
																</li>
																<li title="Laravel" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/laravel.png">
																</li>
																<li title="MySQL" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/mysql.png">
																</li>
																<li title="MS SQL Server" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/sqlserver.png">
																</li>
																<li title="Wordpress" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/wp.png">
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="resume-content">
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="iOS" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/ios.png">
																</li>
																<li title="Android" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/android.png">
																</li>
																<li title="Phonegap" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/phonegap.png">
																</li>
																<li title="Titanium" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/titanium.png">
																</li>
																<li title="Xamarin" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/xamarin.png">
																</li>
																<li title="Rackspace" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/rackspace.png">
																</li>
																<li title="Digital Ocean" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/do.png">
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="resume-content">
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="HTML" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/html.png">
																</li>
																<li title="Bootstrap" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/bootstrap.png">
																</li>
																<li title="CSS" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/css.png">
																</li>
																<li title="JS" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/js.png">
																</li>
																<li title="Dreamweaver" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/dw.png">
																</li>
																<li title="inVision" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/in.png">
																</li>
																<li title="Photoshop" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/ps.png">
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="resume-content">
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="Jira" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/jira.png">
																</li>
																<li title="HP UFT" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/hp.png">
																</li>
																<li title="Selenium" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/selenium.png">
																</li>
																<li title="Slack" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/slack.png">
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="resume-content">
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="Amazon Web Service" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/AWS.png">
																</li>
																<li title="MS Azure " data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/azure.png">
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="resume-content">
													<div class="resume-inner">
														<div class="resume-row">
															...
															<ul class="resume-type">
																<li title="Power PI" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/pi.png">
																</li>
																<li title="Tableau" data-toggle="tooltip" data-placement="top"><img alt="" class="img-responsive" src="assets/images/services/tableau.png">
																</li>
															</ul>
														</div>
													</div>
	...
	<div data-anchor="ourclients" class="pp-scrollable section section-4">
		<div class="scroll-wrap">
			<div class="scrollable-content">
				<div class="vertical-centred">
					<div class="boxed boxed-inner">
						<div class="vertical-title text-dark hidden-xs hidden-sm"><span>Whom we serve</span>
						</div>
						<div class="boxed">
							<div class="container">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="row-partners">
												...
												<div class="col-partner">
													<div class="partner-inner"><a href="http://aerexperts.com" target="_blank"><img alt="" class="img-responsive" src="assets/images/partners/all.png"></a>
													</div>
												</div>
												<div class="col-partner">
												...
												<div class="col-partner">
													<div class="partner-inner"><a href="https://www.hrci.org/" target="_blank"><img alt="" class="img-responsive" src="assets/images/partners/hrci.jpg"></a>
													</div>
												</div>
												<div class="col-partner">
	...
	<div data-anchor="contactus" class="pp-scrollable section section-6">
		<div class="scroll-wrap">
			<div class="section-bg" style="background-size: cover!important;background:url(assets/images/bg/banner.jpg);"></div>
										...
										<div class="footer map_content">
											...
											<div class="title_sponser">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<img class="img-responsive" alt="" src="assets/images/microsoft-iso.png">
												</div>
											</div>
											<div class="clearfix"></div>
