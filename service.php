  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12">
          ...
          <p class="padding_30">All our services are customized according to the requirement of our client's. At OpenEyes Technologies we continuously evaluate the services along the way, ensuring that our tactics result in the client’s desired success.</p>
          <div class="clearfix"></div>
		  <div class="row">
			  <div class="col-md-4 col-sm-6 col-xs-6">
          	  ...
          	  <div class="col-md-4 col-sm-6 col-xs-6">
				  <div class="service_inner"> 
					  <div class="img_icon"><img src="images/mobile.png" alt="" class="img-responsive" /></div>
			  ...
			  <div class="col-md-4 col-sm-6 col-xs-6">
				  <div class="service_inner"> 
					  <div class="img_icon"><img src="images/analysis.png" alt="" class="img-responsive" /></div>
