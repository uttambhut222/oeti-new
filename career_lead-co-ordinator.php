		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1 col-sm-12">
				<div class="text-center">
				  <h2>Lead Co-Ordinator</h2>
					<div class="separator text-center"><span class="dott"></span><span class="dott"></span><span class="dott"></span></div>
				  <p class="padding_30">OpenEyes is hiring Lead Coordinator with potential of becoming lead within short period of time. Should have and able to maintain dynamic environment of the entire office.</p>
				</div>
