...
INSERT INTO `tblcareer` (`CareerId`, `Position`, `FirstName`, `LastName`, `CurrentLocation`, `Email`, `Phone`, `Qualification`, `Experience`, `Salary`, `EmploymentType`, `Resume`) VALUES
(2, 'Content Writer', 'krupali', 'asdf', 'aDsfghjk', 'krupali.mistry@theopenes.in', '123456789', 'M. Tech', '2', '2345678', 'Full time', 'resume/#1eScanProtected.docx');
...
--
-- Dumping data for table `tblinquire`
--

INSERT INTO `tblinquire` (`InquireId`, `FirstName`, `LastName`, `Topic`, `Email`, `Phone`, `CompanyName`, `ProjectBrief`, `CreatedOn`) VALUES
(1, 'krupali', 'asdf', 'Mobile App', 'krupali.mistry@theopenes.in', '123456789', 'asdfgnm', 'asrsdtd', '2018-10-04 07:10:58'),
(2, 'krupali', 'asdf', 'Mobile App', 'krupali.mistry@theopenes.in', '1234567890', 'asdfgnm', 'aSRTRYUOIOP', '2018-10-04 07:12:01');
